...
def show_lp(unfiltered, timestamps, cutoff, fs, order=5):
    ...
    plt.plot(timestamps, filtered, 'g-', linewidth=2, label='Low Pass filtered')
    plt.xlabel('Time [sec]')
...
def show_graphs_hp(unfiltered, timestamps, cutoff, fs, order=5):
